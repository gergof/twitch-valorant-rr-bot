...
export class Migration20260401105345 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`create table "channel" ("id" serial primary key, "twitch_id" varchar(50) not null, "name" varchar(150) not null, "email" varchar(150) not null, "active" boolean not null default true, "valorant_account" varchar(150) null, "credential_id" int null, "created_at" timestamptz not null, "updated_at" timestamptz not null);`);
